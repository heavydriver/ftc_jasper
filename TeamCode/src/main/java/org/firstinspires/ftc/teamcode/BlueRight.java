...
//    private static ColorSensor color = null;
    ...
    public void runOpMode() {
        ...
        carouselServo.setDirection(CRServo.Direction.REVERSE);
...
//        encoderDrive(DRIVE_SPEED, -24, -24, -24, -24, 4.0);  // S3: Reverse 24 Inches with 4 Sec timeout
    ...
    public void carouselRun() {
        carouselServo.setPower(0.7);
        
        while (opModeIsActive()) {
            telemetry.addData("Carousel", carouselServo.getPower());
            telemetry.update();
        }
    }
